...
extern int long_query;
extern int long_query_retry_interval;
extern int long_query_retries;
...
extern ssize_t (*m_write)(int file, const char *buf, gsize len);
extern gboolean stream_use_binary;
